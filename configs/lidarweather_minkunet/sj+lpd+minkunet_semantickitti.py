...
labels_map = {
    0: 19, 1: 19,
    10: 0, 11: 1, 13: 4, 15: 2, 16: 4, 18: 3, 20: 4,
    21: 19, 22: 19, 23: 19,
    30: 5, 31: 6, 32: 7,
    40: 8, 44: 9, 48: 10, 49: 11, 50: 12, 51: 13, 52: 19,
    60: 8, 70: 14, 71: 15, 72: 16, 80: 17, 81: 18,
    99: 19,
        ...
        transforms=[
            dict(
                ...
                pre_transform=[
                    ...
                    dict(type='PointSegClassMapping'),
                    dict(type='RandomJitterPoints', jitter_std=[0.01,0.01,0.01], clip_range=[-0.05,0.05], reflectance_noise=True)
                ],
                pre_transform4orig=[
...
test_pipeline = [
    dict(type='LoadPointsFromFile', coord_type='LIDAR', load_dim=5, use_dim=[0,1,2,3], backend_args=backend_args),
    dict(
        type='LoadAnnotations3D',
        with_bbox_3d=False, with_label_3d=False,
        with_seg_3d=True, seg_3d_dtype='np.int32', seg_offset=2**16,
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/home/vip/harry/LiDARWeather/data/sets/semantickitti',
        ann_file='/home/vip/harry/LiDARWeather/data/sets/semantickitti/semantickitti_infos_val.pkl',
...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        voxel=True, voxel_type='minkunet', batch_first=False,
        max_voxels=80000,
        voxel_layer=dict(
            max_num_points=-1,
